...
ggplot(mpg) + 
  geom_point(aes(displ, hwy, _____ =class)) 
...
# 9. Practice Faceting. Create a plot using facet_wrap but facet on the cyl variable. Use #8 as an example.
...
# 18. Practice. Create a histogram of the depth variable. Experiment with binwidth and theme.
