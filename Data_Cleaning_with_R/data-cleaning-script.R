...
# ---- Collapse columns with the pivot_longer() function ----

# Step 15: Collapse all the critic columns into just "Critic" and "Rating" columns.

movies <- pivot_longer(movies, cols= Critic1:Critic3, names_to = "Critic", values_to = "Rating")
...
# ---- Use join() functions from dplyr to join datasets ----
